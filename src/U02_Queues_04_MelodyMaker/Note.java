...
public class Note {
   ...
   // pre : duration > 0 and 0 <= octave <= 10, otherwise throws an
   ...
   // pre : d must be greater than 0, otherwise an IllegalArgumentException is
   // thrown
   ...
   // returns true if the note is the beginning or ending note in a repeated
   // section,
   // false otherwise
   ...
   // returns a string in the format "<duration> <pitch> <repeat>" if the note is a
   // rest,
