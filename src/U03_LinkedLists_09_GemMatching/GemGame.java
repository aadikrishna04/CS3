...
public class GemGame {
	...
	public static void main(String[] args) {
		...
		StdDraw.textLeft(0.0, PLAYER1_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, "Player1: " + score1);
		StdDraw.textLeft(0.0, PLAYER2_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, "Player2: " + score2);
		
		// Draw a little blue dot to indicate whose turn it is
		StdDraw.setPenColor(StdDraw.BLUE);
		if (turn1)
		StdDraw.filledCircle(INDICATOR_X, PLAYER1_Y + PLAYER_HALF_HEIGHT -
		TEXT_HEIGHT, INDICATOR_RADIUS);
		else
		StdDraw.filledCircle(INDICATOR_X, PLAYER2_Y + PLAYER_HALF_HEIGHT -
		TEXT_HEIGHT, INDICATOR_RADIUS);
