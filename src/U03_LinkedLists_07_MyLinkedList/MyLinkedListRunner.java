...
public class MyLinkedListRunner {
	...
	// @SuppressWarnings("unused")
	// private static void testIterator() //test (Advanced) make linked list
	// iterable
	// {
	// System.out.println("Iterator test");
	//
	// MyLinkedList list = new MyLinkedList(1, 2, 3, 4); //var args constructor for
	// testing. See next lab for info!
	//
